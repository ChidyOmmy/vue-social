        ...
        <v-col cols-md="7" offset-md="2" fixed>
          <v-app-bar class="mr-0 mb-12" fixed color="teal darken-2" dark>
            ...
            <v-list-item two-lines class="mr-0">
              <v-list-item-avatar>
                <v-avatar>
                  <v-img src="https://scontent.fdar2-1.fna.fbcdn.net/v/t1.0-9/98090947_108915614166364_5026416452895244288_n.png?_nc_cat=105&_nc_sid=8024bb&efg=eyJpIjoidCJ9&_nc_eui2=AeEhm3lA7CoHh1RUdPz4HCl6xoc0VY_WB6PGhzRVj9YHozhvblsorJda7dx-tTKgMQDo3_vZFPF8WKG5pYLkWDhiP20yHVMslR3pmXM6JjDLgiErD8m8N5OUl2D-aKQ5MAg&_nc_ohc=kqaTeoDKnQsAX_baBS3&_nc_pt=5&_nc_eh=4e9ce21f98aa5256dcd47387a44007e1&_nc_ht=scontent.fdar2-1.fna&oh=7edf7a032555cfc9f62bbcc77a14ce57&oe=5F4D308E"></v-img>
                </v-avatar>
              </v-list-item-avatar>
              <v-list-item-content>
